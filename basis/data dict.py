...
# 定义一个列表
print '我有几个', len(shop_list), "内容"
for item in shop_list:
    print "循环输出 " + item

shop_list.append('rice')
print '现在具有的内容', shop_list
# 增加内容

shop_list.sort()
print '按照首字母排序', shop_list
print '单独取一个内容', shop_list[0]
# 排序

new_shop = shop_list[0]
del shop_list[0]  # 删除列表内第一个
print '删除一个内容', new_shop
print '剩下全部内容', shop_list
